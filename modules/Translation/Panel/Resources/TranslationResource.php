...
namespace Modules\Translation\Panel\Resources;
...
use Modules\Translation\Panel\Resources\TranslationResource\Pages\CreateTranslation;
use Modules\Translation\Panel\Resources\TranslationResource\Pages\EditTranslation;
use Modules\Translation\Panel\Resources\TranslationResource\Pages\ListTranslations;
...
class TranslationResource extends Resource
{
    ...
    {
        return __('translation::translation.label');
    }

    public static function getNavigationLabel(): string
    {
        return __('translation::translation.navigation');
    }
        ...
        return $table
            ...
            ->columns([
                ...
                TextInputColumn::make(sprintf('text.%s', app()->getLocale()))
                    ->label(__('translation::translation.text'))
                    ->placeholder(__('translation::translation.missing_text', ['locale' => app()->getLocale()])),
