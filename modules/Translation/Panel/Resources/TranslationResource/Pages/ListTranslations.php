...
use Modules\Translation\Actions\Backup;
use Modules\Translation\Actions\Import;
use Modules\Translation\Actions\ImportFromFiles;
use Modules\Translation\Actions\Restore;
...
use Modules\Translation\Panel\Resources\TranslationResource\Forms\ExportForm;
use Modules\Translation\Panel\Resources\TranslationResource\Forms\ImportForm;
        ...
        return [
            ...
            ActionGroup::make([
                Action::make('import_files')
                    ->label(__('translation::translation.btn.import_files'))
                ...
                Action::make('import')
                    ...
                    ->modalDescription(__('translation::translation.import_description'))
                    ...
                    ->action(function (array $data): void {
                        ...
                        try {
                            ...
                            Notification::make()
                                ->success()
                                ->title(__('translation::translation.file_imported'))
                                ->send();
                        } catch (Exception $e) {
                            Log::error($e);
                            ...
                            Notification::make()
                                ->danger()
                                ->title(__('translation::translation.import_failed'))
                                ->body(__('translation::translation.import_file_invalid'))
                                ->persistent()
                                ->actions([
                                    Action::make('view')
                                        ->label(__('translation::translation.view_template'))
                ...
                Action::make('export')
                    ...
                    ->modalWidth(Width::Medium)
                    ->modalDescription(__('translation::translation.export_description'))
                    ...
                    ->action(function (array $data): ?StreamedResponse {
                        try {
                            ...
                            Notification::make()
                                ->success()
                                ->title(__('translation::translation.export_success'))
                                ->send();
                            ...
                            Notification::make()
                                ->danger()
                                ->title(__('translation::translation.export_failed'))
                                ->send();
                        }
