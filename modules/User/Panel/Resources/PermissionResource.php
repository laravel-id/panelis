...
use Modules\User\Panel\Resources\PermissionResource\Pages\ManagePermissions;
...
class PermissionResource extends Resource
{
    ...
    {
        return __('user::user.permission.label');
    }

    public static function getNavigationLabel(): string
    {
        return __('user::user.permission.navigation');
    }
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema
            ...
            ->components([
                TextInput::make('name')
                    ->label(__('user::user.permission.name'))
                    ->disabledOn('edit')
                    ->required()
                ...
                TextInput::make('guard_name')
                    ->label(__('user::user.permission.guard_name'))
                    ->disabledOn('edit')
                    ->default('web')
                    ->datalist(['web', 'api'])
                    ->required(),
