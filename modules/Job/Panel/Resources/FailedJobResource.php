...
use Modules\Job\Panel\Resources\FailedJobResource\Pages\ListFailedJobs;
...
class FailedJobResource extends Resource
{
    ...
    {
        return __('job::job.failed.label');
    }

    public static function getNavigationLabel(): string
    {
        return __('job::job.failed.navigation');
    }
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('failed_at')
                    ->label(__('job::job.failed.failed_at'))
                    ->date(get_datetime_format()),

                TextColumn::make('exception')
                    ->label(__('job::job.exception'))
            ...
            ->toolbarActions([
                BulkAction::make('retry_selected')
                    ->label(__('job::job.btn.retry_selected'))
                    ->visible(user_can(FailedJobPermission::Retry))
                    ->requiresConfirmation()
                    ->icon(Heroicon::OutlinedArrowPath)
